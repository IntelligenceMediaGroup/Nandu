...
define( 'URL', 'http://imgroup.lv/nandu/' );
define( 'SECUREURL', 'http://imgroup.lv/nandu/' );
...
define('DOWNLOADROOT', 'C:\wamp\www\joomla/');
...
define('CHECK_STOCK', '');
define('ENCODE_KEY', '7c68eee97189dab8d8edaf279bb33a61');
define('NO_SHIPPING', '');
define('NO_SHIPTO', '');
...
$VM_BROWSE_ORDERBY_FIELDS = array( 'product_name','product_cdate' );
