...
mysql_query("UPDATE jos_piza SET title_lv = '$title_lv', title_ru='$title_ru', category='$category', img='$img', descr_lv='$descr_lv', descr_ru='$descr_ru', size='$size', weight='$weight', price='$price', size2='$size2', weight2='$weight2', price2='$price2' WHERE id = '$uid'");
echo 'done';
mysql_close($con);
